...
<tr>
        <th colspan="11">
                <div class="titlediv"><h1 class="newstitle">Backup Jobs in the last <TMPL_VAR NAME=JOBS_SINCE_DAYS> days</h1></div>
        </th>
</tr>
</thead>
...
<td style="padding-left: 3px; padding-right: 3px;" classname="dataTD10"><a href="<TMPL_VAR NAME=Bweb_Path>job/details/<TMPL_VAR NAME=JobId>"><TMPL_VAR NAME=Status></a></td>
